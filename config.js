...
module.exports = {
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~d0a9d8a9e9e7a6ed8b5cb108bf371009:4d7a334b774d6a576971633d').trim() || '',
    ...
    SUDO: process.env.SUDO || "94785153782",
